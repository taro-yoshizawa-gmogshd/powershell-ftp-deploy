...
```powershell
powershell -ExecutionPolicy Bypass -File ".\ftps_ls.ps1" -RemoteDir "/images/"
```
...
```powershell
powershell -ExecutionPolicy Bypass -File ".\ftps_cat.ps1" -RemoteFile "/logs/app.log"
```
